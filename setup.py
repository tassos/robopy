...
setup(
    ...
    long_description='ROBOPY is a Python implementation of The Robotics Toolbox (RTB) (The brainchild of Peter Corke) '
    ...
    # Author details
    author='Aditya Dua',
    author_email='adityadua24@gmail.com',
    ...
    include_package_data=True, install_requires=['vtk', 'ipyvolume', 'matplotlib', 'numpy', 'numpy-stl','scipy', 'trimesh', 'Pillow']
    # packages=find_packages('robopy'),
    # package_dir={'':'robopy'},
    # package_data={
    #     'base': ['media/puma_560/*.stl'],
    # },
